...
Provided answers:
Stale report policy: ${inputs.staleReportPolicy}
Generate CLAUDE.md: ${inputs.generateClaude ? 'yes' : 'no'}
Generate rules: ${inputs.generateRules ? 'yes' : 'no'}
Generate skills: ${inputs.generateSkills ? 'yes' : 'no'}
